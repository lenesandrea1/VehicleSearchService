...
public static class KnownIds
{
    ...
    public static readonly Guid LocationParis = Guid.Parse("A0000001-0000-0000-0000-000000000003");
    ...
    public static readonly Guid VehicleWrongMarket = Guid.Parse("B0000001-0000-0000-0000-000000000003");
    public static readonly Guid VehicleOutOfService = Guid.Parse("B0000001-0000-0000-0000-000000000004");
    public static readonly Guid VehicleParis = Guid.Parse("B0000001-0000-0000-0000-000000000005");
